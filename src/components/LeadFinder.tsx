    ...
    <div className="p-6 bg-slate-900 text-white rounded-xl border border-slate-800 shadow-xl">
      <div className="mb-6">
        ...
        <p className="text-slate-400 text-sm">
          Find local businesses with poor accessibility scores in any market.
        </p>
      </div>
      ...
      <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4 mb-6">
        <div className="flex-1">
          ...
          <input
            type="text"
            placeholder="e.g. Dentists, Law Firms, Real Estate"
            value={industry}
        ...
        <div className="flex items-end">
          ...
          >
            {loading ? <><span className="animate-spin">⟳</span> Scanning...</> : "Find Leads"}
          </button>
        </div>
      </form>
